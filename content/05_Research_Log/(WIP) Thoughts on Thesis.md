...
refer to [[Material Culture of Computation]]
...
My research drew immense inspiration from know-hows accumulated by e-textile practitioners such as Irene Posche. I aim to contribute to the domain in following specific topics:

1. Considering craft making and computational engineering as an interrelated human activities, rather than broken worlds, histories, and territories.
2. In the context of computational design, proposing Material-Oriented Design as an alternative design methodology in contrast with Object-Oriented Design (OOD).
3. Adopting and comparing different textile techniques in the making of electronic technology, including felting, weaving, knitting, and machine embroidery.
4. Extending

Digital is in continuation from the analog, just with more abstraction and hence loosing the detail in between 1 and 0.
Digital needs to resurface/oscillate back to analog experience for it to speak to human.

The process I use for the resurfacing is riso, etextile, where materiality makes it possible.
