...
- discrete, incremental fixed jumps
![[Pasted image 20260215144507.png]]
![[Pasted image 20260215144651.png]]
- Analytical engine in 1833 marked the transition from calculation to computation, generalization
	...
	- punch card: algorithm is transferred to operation card, programmable
![[Pasted image 20260215151328.png]]
![[Pasted image 20260215151422.png]]
...
- From mathematical machine to general purpose computer
	- the realization the the number can represent entity other than quantity
 ![[Pasted image 20260215152605.png]]
...
[Dr Doron Swade, lecture in Gresham College](https://www.gresham.ac.uk/watch-now/grand-narrative-history-computing)
...
- **Kilobyte (KB)** ≈ 1,000 bytes _(or 1,024 in binary context)_
...
_(Binary definition uses powers of 2, decimal uses powers of 10.)_
...
Computers don’t just _store_ numbers — their real power is **computation**: manipulating numbers in structured ways (add, subtract, compare, etc.).  
The component that performs this work is the **ALU — Arithmetic Logic Unit**, often called the _mathematical brain_ of the computer.
...
The ALU needs instructions telling it _what_ to do.
