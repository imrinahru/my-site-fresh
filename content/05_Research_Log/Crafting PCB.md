...
- Process: 
	1. Research topoR, how to generate an efficient circuit?
	...
	6. Draw on a scaled piece of cloth? like that of an [[(WIP) Peruvian Textile|Amazonian pattern]]
	7. Variation: Multi-layered statue of PCB


## Reference


Hand-drawn patterns found on Shutterstock:
![[pcb.png]]
![[shutterstock.com_pcb.png]]
![[alamy.com_pcb.png]]
![[alamy.com_HDTEAE.png]]
![[alamy.com_J0M3BD.png]]
![[pcb2.png]]
...
https://oldcrap.org/
![[oldcrap_pcb.png]]
ease of design the way cad software is written limiting yourself to 45 degree bends is simply
