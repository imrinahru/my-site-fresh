---
title: Riso Workshop with Digital Futures (2025)
date: 2025-11-16
tags:
  - event
...
![[WhatsApp Image 2026-03-07 at 8.35.03 PM 1.jpeg]]
## Overview  
...
### A Quick Digital Preview

In photoshop, the gray scaled layers can be quickly overlayed to simulate the print result.
Select a layer, go to image-> adjustments->gradient map, change to riso ink color.
Do the same for all the layers and multiply.
