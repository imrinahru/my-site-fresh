...
![[servo parameters.png]]
![[3pin electrical connections.png]]
...
![2servoWithplug_bb-1]({{ '/content/assets/img/2servoWithplug_bb-1.png' | relative_url | uri_escape }})
- add as many servos as needed
![[4 servos in a loop.png]]
...
```
functionﾂsendAttachStateToArduino() {
...
function displayText() {
  ...
  textAlign(LEFT);
  textSize(16);
  text("Left Servo Angle: " + servoAngle1 + "ﾂｰ (Range: " + servo1Min + "ﾂｰ - " + servo1Max + "ﾂｰ)", 20, height - 40);
  text("Right Servo Angle: " + servoAngle2 + "ﾂｰ (Range: " + servo2Min + "ﾂｰ - " + servo2Max + "ﾂｰ)", 20, height - 20);
}
...
class Servo {
  ...
  update() {
    if (this.isMoving) {
      ...
      // Example: If moving from 0ﾂｰ to 180ﾂｰ and progress is 0.5:
...
function displayText() {
  ...
  text("Left Servo Angle: " + servoAngle1 + "ﾂｰ (Range: " + servo1Min + "ﾂｰ - " + servo1Max + "ﾂｰ)" + servo1Status, 20, height - 60);
  
  // Servo 2 info with attach state
  let servo2Status = servoAttach2 ? " [ATTACHED - MOVING]" : " [DETACHED - IDLE]";
  text("Right Servo Angle: " + servoAngle2 + "ﾂｰ (Range: " + servo2Min + "ﾂｰ - " + servo2Max + "ﾂｰ)" + servo2Status, 20, height - 40);
