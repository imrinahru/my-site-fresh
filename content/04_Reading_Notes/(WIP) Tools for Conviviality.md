---
title: Ivan Illich (1989)・Tools for Conviviality
date: 2025-07-04
tags:
  - reading
draft: true
summary: Modern industrial institutions and technologies have outgrown the human scale. Convivial tools should allow everyone to act autonomously, cooperate, and shape their own environment.
link: https://archive.org/details/illich-conviviality/page/130/mode/2up
---
...
Ivan Illich's _Tools for Conviviality_ argues that modern industrial institutions and technologies have outgrown the human scale. As tools become more powerful and interdependent, they no longer extend freedom; they condition people to serve the system. Reestablishing conviviality means redesigning tools and institutions so that everyone can act autonomously, cooperate, and shape their own environment.

- Illich's observation applies to school, medical, and transportation, that when the complexity, professionalism, and centralization of the domain exceeds a certain natural _limit_, it enslaves people by adding great cost to the whole society, while only a few can benefit from the result.
- More is not better. Progress is not the solution.
- We need tools that work _with_ us, that enhance people's freedom, that bring out our energy and imagination.
...
- This political process will find its concrete expression in a series of temporary agreements on one or the other _concrete limitation of means_, constantly adjusted under the pressure of conflicting insights and interests.
...
>  Hand tools are those which adapt man's metabolic energy to a specific task. 
>  Power tools are moved, at least partially, by energy converted outside the human body. Some of them act as amplifiers of human energy: the oxen pull the plow, but man works with the oxen - the result is obtained by pooling the powers of beast and man. 
>  On the other hand, the energy used to steer a jet plane has ceased to be a significant fraction of its power output. The pilot is reduced to a mere operator guided by data which a computer digests for him. The machine needs him for lack of a better computer; or he is in the cockpit because the social control of unions over airplanes imposes his presence.
...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| **Tools for Work**      | Simple, flexible tools used creatively (e.g., hand tools) for individual goals                                                        | Only _results_ can be marketed                                                  | Crafted items, home-cooked meal                                     |
...
When a single class of industrial tools becomes the _only_ socially recognized way to meet a basic need, it enjoys a radical monopoly. Cars redefine mobility, schools redefine learning, hospitals redefine care. Alternative, simpler practices are first marginalized, then rendered impossible by zoning, licensing, or sheer cost.
...
![valuableskill]({{ '/content/assets/img/valuableskill.png' | relative_url | uri_escape }})
![scarecefactor]({{ '/content/assets/img/scarecefactor.png' | relative_url | uri_escape }})
![whattolearn]({{ '/content/assets/img/whattolearn.png' | relative_url | uri_escape }})
...
> [!NOTE] AI
> Can AI be a high-level of convivial tools that allow high-level of self-learning complex knowledge?
...
>  the possibility of a society where work and leisure and politics would favor learning and that could function with less formal education; (...)
>  permits us to set up educational arrangements that favor self-initiated, self-chosen learning, and that relegate programmed teaching to limited, clearly specified occasions.


#### Health

Health becomes inaccessible when self-care is impossible.
Illich imagines health knowledge as once widespread and commons-based.
...
- Postindustrial politics focuses on _tool limits_, not production targets.
...
But we don't because of systemic bias.
Illich identifies a **systemic distortion**:
...
Unchecked industrial growth erodes the physical environment, saturates people with compulsory consumption, and fragments communities. True ecological correction demands _less_ total throughput, not merely “cleaner” throughput; otherwise pollution is only displaced or delayed, and social disintegration deepens.
...
- Freedom requires _collective boundary-setting_ on scale, speed, throughput.
### Human Limits
...
>  Never before have tools approached present power. Never before have they been so integrated at the service of a small elite. 
>  High-speed transportation, broad band-width communication, special health maintenance, and unlimited bureaucratic assistance are all explained as requirements to get the most out of the most highly capitalized people.
...
- Simply trying to fix _income inequality_ or _uneven outcomes_ (outputs) doesn't solve the deeper issue: the unequal **structure of inputs**, that is, who gets access to meaningful tools, opportunities, and roles in society.
...
- Nonindustrial work (care, household, kin-making) is devalued _yet indispensable_.
...
- We must instead build a society based on:
    ...
    - **Stable boundaries** that are _agreed upon_, not imposed,
        
    - **Incentives** to help more people live better with _less_, through creativity and cooperation.

How to Make This Possible (3 Steps)**

Illich says this vision sounds idealistic _only because we haven窶冲 yet built the tools to realize it._ He outlines three practical tasks:
...
Progress need not mean bigger or faster; it can mean _deeper_: richer relationships, more meaningful work, and technologies scaled to enhance rather than eclipse human capacities. Achieving this requires:
...
### Moral, Political, and Legal Institutions Have Been Co-opted
...
Mythical Majorities Are Politically Paralyzing**

- In rich societies, most people are **complicit consumers** who, in some way, **harm the environment**.
    
- Political myths **transform this numerical fact into the idea of a unified voting bloc** that supports endless growth.
    
- This mythical bloc is **invoked by those in power** to shut down change: 窶弩e can窶冲 stop growth窶農they_ won窶冲 allow it!窶・    

> 竜・・_But this majority doesn窶冲 exist窶俳nly the myth does._

---

### These 窶廴ajorities窶・Are Actually Individuals with Conflicting Interests**

- When you look closely, the people grouped together under this myth **don窶冲 actually share the same goals**:
    
    - The **ecologist** who flies to a climate conference,
        
    - The **economist** trying to create jobs,
        
    - The **working-class consumer** in Detroit buying a TV.
        
- They are **individuals making compromises**, not a **cohesive political force** for growth.


There can be no such thing as a majority opposed to an issue that has not arisen. A majority agitating for limits to growth is as ludicrous a concept as one demanding growth at all cost. Majorities are not created by shared ideologies. They develop out of enlightened self-interest. 


Large institutions can quite suddenly lose their respectability, their legitimacy, and their reputation for serving the public good. It happened to the Roman Church in the Reformation, to Royalty in the Revolution. The unthinkable became obvious overnight: that people could and would behead their rulers.


- Today窶冱 unemployment and breakdowns in production are being 窶徭olved窶・by **creating more jobs in decision-making, control, and therapy**窶馬ot in meaningful, productive work.
    
- Society still clings to **industrial ideals**, believing we can have **both limitless growth and ecological sustainability**.
    
- This obsession **blinds us** to the possibility of a **postindustrial society** with **diverse, balanced forms of production** (e.g., subsistence, craftsmanship, community care).

what is good enough for all.

### **The Right Tool for Transformation: Politics and Law**

- Illich argues that **only one kind of tool** can guide society through collapse toward renewal:
    
    - The **formal structure of politics and law**窶馬ot as bureaucracy, but as a shared process of decision-making among equals.
        

> 笞厄ｸ・_It窶冱 not technology or ideology that will save us窶琶t窶冱 our capacity for fair, participatory political action._

---

### Crisis Becomes Opportunity Only Through Collective Confidence**

- When the crash comes (an **industrial collapse**, not just economic), the outcome depends on whether a **new group of conscious citizens** can:
    
    - Inspire **trust and clarity** in others,
        
    - Help people **understand the crisis**, and
        
    - **Lead the use of political procedures** to reshape society.
        

> 煤 _Collapse doesn窶冲 automatically lead to renewal窶琶t requires leadership rooted in democratic confidence._

---

### Convivial Procedure: The Heart of a Just Transition**

- This new politics must:
    
    - **Acknowledge conflicting interests**,
        
    - Recognize the **historical roots of conflict**,
        
    - Accept **peer-based decisions** (not imposed rules).
        
- Such a **"convivial use" of procedure** ensures that:
    
    - The revolution doesn窶冲 turn into **a new bureaucracy**,
        
    - Goals **emerge through action**, rather than being imposed from above.
        

> 屏・・_It窶冱 not about a blueprint, but about trusting process to guide purpose._

---

### Labels Don窶冲 Matter窶乃he Process Does**

- Whether you call this transformation:
    
    - a **cultural revolution**,
        
    - **participatory socialism**,
        
    - the **recuperation of law**, or
        
    - a return to **local legal traditions** (like the _Fueros de Espaﾃｱa_),
        
    
    the label isn窶冲 important.
    
- What matters is that **people reclaim the political process as their own**, and use it **consciously and cooperatively**.

## About Liberty

### **The Problem: Liberty Has Been Misunderstood**

- In both **capitalist** and **socialist** societies, liberty has been wrongly defined as the **right to use more powerful tools** without limits.
    
    - In capitalism: this means individuals or corporations claim unlimited rights to consume.
        
    - In socialism: the state claims the right to grow and produce endlessly.
        
- This misunderstanding has made it harder to recognize the **true political process**窶俳ne based on **limits, not endless growth**.


## Industrialization of Man


The convergence of corporate monopolies on the deep structural level of society can be called the industrialization of man. This trend must be inverted if people are to be free. But the industrial corruption of language itself makes this issue terribly difficult to formulate.
...
What was at issue was control over the tools of production. Such were the events which brought the Marxists to power in Eastern Europe. But the crisis I have described as imminent is not a crisis within industrial society, but a crisis of the industrial mode of production itself The crisis I have described confronts people with a choice between convivial tools and being crushed by machines. The only response to this crisis is a full recognition of its depth and an acceptance of inevitable self-limitations. 

### You Don窶冲 Need a Unified Majority to Limit Institutions**

- People who support **limits on industrial systems** don窶冲 need to share the same ideology.
    
- In a democracy, **majorities are often formed by people with very different reasons** for supporting the same action.
    

> 竜・・_Political coalitions form around shared goals窶馬ot shared beliefs._

---

### Example: Public School Opposition**

- People may oppose the school system for very different reasons:
    
    - They don窶冲 have kids and resent paying taxes.
        
    - They feel their district is unfairly treated.
        
    - They prefer private or religious schooling.
        
    - They oppose compulsory education on moral or philosophical grounds.
        
- These groups **don窶冲 form a party or movement**, but **together** they could vote to **reduce the size or power** of the school system.
    

> 笨ゑｸ・_Such a vote may be conservative in effect窶琶t shrinks the system, but also helps it survive in a more legitimate, limited form._

---

### In Normal Times, Majorities Tend to Be Conservative**

- Under 窶彙usiness-as-usual窶・politics, even when people vote for limits, they often end up **preserving the institution**窶破ust in smaller, more acceptable form.
    
- So even 窶彡utting down to size窶・is not revolutionary; it窶冱 **stabilizing**.
    

> ｧｩ _Majorities don窶冲 reshape systems during normal times窶杯hey adjust them._

---

### But Crises Create a Different Kind of Majority**

- When **many institutions fail at once**窶覇ducation, transport, health, justice窶琶t becomes clear that **industrial society itself** is the problem, not just its parts.
    
- This kind of **deep systemic crisis** creates a chance for a **new majority**, one that sees through the whole illusion of infinite institutional growth.
    

> 謙・・_Only when the system itself breaks down can people unite to build something truly different._


### he Power of Law and Language, Even When Abused**

- Even in corrupt or unjust societies, where legal systems are:
    
    - **Restricted to the privileged**, or
        
    - **Used to justify authoritarianism** (e.g., show trials),
        
    
    the **appeal to law and formal procedure** still holds deep moral and symbolic power.
    
- This is especially true when it窶冱 tied to **ordinary language** and **historical traditions** of a people.
    

> 笞厄ｸ・_The formal structure of justice窶覇ven when abused窶敗till offers a way to speak truth and resist domination._

---

### Speaking Through the 窶弩ord窶・Is a Revolutionary Act**

- Illich describes the **"word recovered from history"**窶杯he shared, ordinary, communal use of language and procedure窶蚤s the **last, fragile, but potent tool** left to humanity.
    
- Even if revolutionaries **mock or dismiss** this kind of appeal, it remains the **most honest and powerful form of resistance**.
    
- Why? Because it can **unite people** and **transform inevitable violence** into **convivial reconstruction**窶蚤 rebuilding of society based on cooperation, limits, and meaning.

%% It will be disastrous if our language is also taken away by the tools %%
