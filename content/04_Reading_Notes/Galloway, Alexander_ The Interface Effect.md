---
title: Galloway, Alexander (2012) — The Interface Effect
date: 2025-10-22
tags:
  - reading
  - ux-design
  ...
  - capitalism
draft: false
summary: Interfaces are not neutral tools but mediating effects that both shape and are shaped by larger social, political, and economic forces
link:
---
...
- The **social field** operates as a _grand interface_ between:
...
- The digital worldview reinforces this _binary totalization_ of experience.
...
> [!NOTE]
> Technology itself builds and reinforces specific **cultural logics**, such as binary thinking, quantification, and totalization. Designers rarely foresee how their creations ripple across societies. Subtle cues embedded in interfaces (e.g., timestamps, metrics, metrics of visibility) normalize these logics in everyday perception.
...
- Tiqqun. _Introduction to Civil War_ (Empire as environment)
    
- Žižek. _In Defense of Lost Causes_ (return to universal truth)
    
- Galloway. _Protocol: How Control Exists After Decentralization_
    
- Chun, Wendy Hui Kyong. _Programmed Visions: Software and Memory_

---


![[galloway_alexander_interface-effect.pdf]]